export const zh = {
  translation: {
    ...
    downvotes_disabled: "反对投票已禁用",
    enable_downvotes: "启用反对投票功能",
    upvote: "点赞",
    number_of_upvotes: "{{count}} 个赞",
    downvote: "反对",
    number_of_downvotes: "{{count}} 个反对",
